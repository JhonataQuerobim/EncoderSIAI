 ...
 */
CalculaPosVel::CalculaPosVel(int *p, int sent)
{
    pinos = p;
    for (int i = 0; i < 8; i++) {
...
/*
  Construtor de cópia
 */
CalculaPosVel::CalculaPosVel(const CalculaPosVel &c)
{
  pinos = c.pinos;
  contagem = c.contagem;
  posicao = c.posicao;
...
/*
  Retorna a posição
 */
double CalculaPosVel::getPosicao()
{
  calculaPosicao();
  return posicao;
}
 ...
 */
double CalculaPosVel::getVelocidade()
{
  calculaPosicao();
  calculaVelocidade();
  return velocidade;
 ...
 */
void CalculaPosVel::calculaContagem()
{
  int recebe;
  int somaParcial = 0;
 ...
 */
void CalculaPosVel::calculaPosicao()
{
  calculaContagem();
 ...
 */
void CalculaPosVel::calculaVelocidade ()
{
